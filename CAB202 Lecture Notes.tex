...
When a case is matched, a \mintinline{c}{break} statement can be used to prevent the program from falling
through the case. The \mintinline{c}{default} case is executed if no case is matched.
\end{document}
